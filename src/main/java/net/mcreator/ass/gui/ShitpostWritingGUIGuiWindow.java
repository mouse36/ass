...
public class ShitpostWritingGUIGuiWindow extends ContainerScreen<ShitpostWritingGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "WRITE YOUR FUNNY SHIT", 32, 8, -12829636);
		this.font.drawString(ms, "IN THE TEXT FIELDS BELOW", 26, 20, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		text1 = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 32, 120, 20, new StringTextComponent("FUNNY SHIT HERE")) {
			{
		...
		text2 = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 52, 120, 20, new StringTextComponent(""));
		guistate.put("text:text2", text2);
		text2.setMaxStringLength(32767);
		this.children.add(this.text2);
		text3 = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 72, 120, 20, new StringTextComponent(""));
		guistate.put("text:text3", text3);
		text3.setMaxStringLength(32767);
		this.children.add(this.text3);
		text4 = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 92, 120, 20, new StringTextComponent(""));
		guistate.put("text:text4", text4);
		text4.setMaxStringLength(32767);
		this.children.add(this.text4);
		text5 = new TextFieldWidget(this.font, this.guiLeft + 27, this.guiTop + 112, 120, 20, new StringTextComponent(""));
		guistate.put("text:text5", text5);
		text5.setMaxStringLength(32767);
		this.children.add(this.text5);
		this.addButton(new Button(this.guiLeft + 195, this.guiTop + 104, 50, 20, new StringTextComponent("GOTEM"), e -> {
			if (true) {
				AssMod.PACKET_HANDLER.sendToServer(new ShitpostWritingGUIGui.ButtonPressedMessage(0, x, y, z));
				ShitpostWritingGUIGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
