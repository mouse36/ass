...
public class PoopBlock extends AssModElements.ModElement {
	@ObjectHolder("ass:poop")
	public static final Block block = null;
	public PoopBlock(AssModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("It is not known what mysterious"));
			list.add(new StringTextComponent("entity pooped this out."));
			list.add(new StringTextComponent("Even rabbits poop large turds."));
		}
