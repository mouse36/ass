...
public class EitherBlock extends AssModElements.ModElement {
	@ObjectHolder("ass:either")
	public static final Block block = null;
	public EitherBlock(AssModElements instance) {
		super(instance, 44);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("2748"));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ass:either_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 4)).range(4).square()
					.func_242731_b(4);
			event.getRegistry().register(feature.setRegistryName("either"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ass:either"), configuredFeature);
		}
	}
	@SubscribeEvent
