...
public class ShicksBlock extends AssModElements.ModElement {
	@ObjectHolder("ass:shicks")
	public static final Block block = null;
	public ShicksBlock(AssModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A humble brown building block."));
			list.add(new StringTextComponent("(dont use this for building wtf)"));
		}
