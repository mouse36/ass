...
public class SmoothShicksBlock extends AssModElements.ModElement {
	@ObjectHolder("ass:smooth_shicks")
	public static final Block block = null;
	public SmoothShicksBlock(AssModElements instance) {
		super(instance, 8);
	}
