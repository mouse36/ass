...
public class CoarseShicksBlock extends AssModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A building block that"));
			list.add(new StringTextComponent("goes harder than"));
			list.add(new StringTextComponent("its wetter counterpart."));
		}
