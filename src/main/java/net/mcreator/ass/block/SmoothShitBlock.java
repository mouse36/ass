...
public class SmoothShitBlock extends AssModElements.ModElement {
	@ObjectHolder("ass:smooth_shit")
	public static final Block block = null;
	public SmoothShitBlock(AssModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This shit is wet."));
			list.add(new StringTextComponent("You have nothing else to"));
			list.add(new StringTextComponent("say about it."));
		}
